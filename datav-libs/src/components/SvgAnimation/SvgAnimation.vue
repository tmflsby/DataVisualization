  ...
  <div>
    <div class="container">
      ...
      -->
        ...
        -->
        <rect x="0" y="0" width="100" height="50" fill="none" stroke="blue" stroke-width="5" stroke-dasharray="10 20"></rect>
      </svg>
    </div>

    <div class="container">
      <svg width="440" height="440" viewBox="0 0 440 440">
        <circle cx="220" cy="220" r="200" stroke-width="10" stroke="#d1d3d7" fill="none"></circle>
        <!--
          周长2*3.1415926*200 = 1257
          利用transform="matrix(0, -1, 1, 0, 0, 440)"旋转圆，让动画起点从上方开始
        -->
        <circle cx="220" cy="220" r="200" stroke-width="10" stroke="#00a5e0" fill="none" class="circle" transform="matrix(0, -1, 1, 0, 0, 440)"></circle>
      </svg>
    </div>

    <div class="container">
      <svg width="200" height="200">
        <rect x="0" y="0" width="200" height="200" stroke-width="8" stroke="#d1d3d7" fill="none"></rect>
        <rect x="0" y="0" width="200" height="200" stroke-width="8" stroke="#00a5e0" fill="none" transform="matrix(0, 1, -1, 0, 200, 0)" class="rect"></rect>
      </svg>
    </div>
    ...
    <div class="container">
      <svg width="200" height="200">
        ...
        <path d="M10 10 L110 10 L110 110 L10 110 Z" fill="none" stroke="pink"></path>
      </svg>
    </div>
    ...
    <div class="container">
      <svg width="200" height="200">
        <rect x="0" y="0" fill="red" width="10" height="10">
          ...
          <animateMotion id="forward-rect" path="M10 10 L110 10 L110 110 L10 110" dur="2s" rotate="0" fill="freeze" begin="0; back-rect.end + 0.5s"></animateMotion>
          <!-- begin="forward-reat.end" 获取到上个动画的结束时间-->
          <animateMotion id="back-rect" path="M10 110 L110 110 L110 10 L10 10" dur="2s" rotate="0" fill="freeze" begin="forward-rect.end + 0.5s"></animateMotion>
        ...
        <path d="M10 10 L110 10 L110 110 L10 110" fill="none" stroke="pink"></path>
      </svg>
    </div>
      ...
      <svg viewBox="0 0 200 200" width="200" height="200">
        <g id="rect1">
          <rect x="0" y="0" rx="0" ry="0" width="100" height="100" fill="red">
            <animate attributeType="XML" attributeName="fill" from="red" to="green" begin="rect1.click" dur="2s" fill="freeze"></animate>
          </rect>
        </g>
        <animateTransform attributeType="XML" attributeName="transform" type="translate" from="0, 0" to="50, 50" begin="rect1.click" dur="2s" fill="freeze"/>
        <rect x="0" y="100" width="100" height="100" fill="blue">
          <animate attributeType="XML" attributeName="fill" from="blue" to="green" begin="rect1.click" dur="2s" fill="freeze"/>
        </rect>
      </svg>
    </div>
